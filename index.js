...
managers.push(new (require('./manager.morse'))({ name: 'morse', logger: logger, fb: fb }))
managers.push(new (require('./manager.painting'))({ name: 'painting', logger: logger, fb: fb, EE: EE }))
